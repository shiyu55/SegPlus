...
import { Row, Col, Card, Button, Drawer, Table, Tabs, Tag, Space } from 'antd';
import { useModel } from 'umi'
import { G2, Chart, Tooltip, Interval, Coord, PieChart, Axis, Geom, Coordinate } from "bizcharts";
   ...
   return (
      <PageContainer>
         <Drawer
            ...
            destroyOnClose
         >
            <Table columns={columns} dataSource={data3} wize={200} />
